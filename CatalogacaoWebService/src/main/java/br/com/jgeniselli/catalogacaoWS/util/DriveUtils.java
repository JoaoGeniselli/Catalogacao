...
public class DriveUtils {
    ...
    private static final List<String> SCOPES =
        Arrays.asList(DriveScopes.DRIVE_FILE, DriveScopes.DRIVE_METADATA, DriveScopes.DRIVE, DriveScopes.DRIVE_APPDATA, DriveScopes.DRIVE_READONLY);
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
            DriveUtils.class.getResourceAsStream("/client_secret.json");
    ...
    public static File insertImage(byte[] stream, String name, String description, String filename) throws IOException {
        ...
        IOUtils.copy(new ByteArrayInputStream(stream), 
